...
\draw (0,0) node[left] {A} 
			to[R=\SI{3.3}{\kilo\ohm}, o-*] ++(2,0) coordinate (1)
			to[short] ++(0,0.5)
...
\begin{tikzpicture}[bookcircuit]
\draw (0,0) node [left] {A}
	to[short,o-*]                  ++(1,0) coordinate (1)
    to[R, R=\SI{70}{\kilo\ohm},-*] ++ (0,-2)
(1) to[R, R=\SI{20}{\kilo\ohm},-*] ++(2,0) coordinate (2)
    to[R, R=\SI{100}{\kilo\ohm},-*] ++(0,-2)
(2) to[R, R=\SI{80}{\kilo\ohm},-*] ++(2,0) coordinate (3)
...
\item
\label{que:gellatticenetwork2}
Gegeven is het weerstandsnetwerk in figuur~\ref{fig:gellatticenetwork}. De weerstandswaarden zijn nu de \textsl{helft} van de waarden in de figuur. Bepaal de vervangingsweerstand tussen de punten A en B.
...
\draw (0,0) to[V, v=\SI{24}{\volt}] ++(0,2)
			to[R=\SI{1}{\mega\ohm},-*] ++(2,0) coordinate (1)
			to[R=\SI{1}{\mega\ohm},-*] ++(0,-2) coordinate (2)
			to[short,-.] (0,0)
		(1) to[short] ++(2,0)
...
\draw (0,0) to[V=\SI{18}{\volt}] ++(0,2)
			to[short,-*,i=$I$] ++(2,0) coordinate (A)
			to[R=\SI{12}{\ohm},-*] ++(0,-2)
		(A) to[short,-*] ++(1,0) coordinate (B)
            to[short] ++(0,0.5)
			to[R=\SI{18}{\ohm}] ++(4,0)
			to[short,-*] ++(0,-.5) coordinate (C)
        (B) to[short] ++(0,-0.5) 
			to[R=\SI{4}{\ohm}] ++(2,0)
...
\begin{tikzpicture}[bookcircuit]
\draw (0,0) node [left] {A}
    to[R, R=$R_1$,-*] ++(2,0) coordinate (2) node[above] {X}
    to[R, R=$R_2$,-*] ++(0,-2)
(2) to[R, R=$R_1$]    ++(2,0) coordinate (3) node[above] {Y}
    to[R, R=$R_L$]    ++(0,-2)
	to[short,-o]        (0,-2) node (4) [left] {B}
;
\end{tikzpicture}
...
%%%            to[R, R=$R_X$] ++(0,-2)
%%%            to[short] (2) 
\draw (0,0) to[V, v=\SI{48}{\volt}]   ++(0,4) coordinate (1) node [left] {}
            to[short, i=$I_x$] ++(3,0)
			to[R=$R_X$, -*] ++(0,-2) coordinate (1)
			to[short] ++(-1,0)
...
\draw (0,1) to[V, v=\SI{12}{\volt}] ++(0,2) %node (1) {} node [left] {}
            to[R=\SI{10}{\kilo\ohm}, -*] ++(2,0) coordinate (1)
			to[short,-o] ++(1,0) node[right] {A}
        (1) to[R=\SI{5}{\kilo\ohm},-*] ++(0,-2)
			to[open,-o] ++(1,0) node[right] {B}
			to[short,-.] ++(-3,0)
;
\draw (6,0) to[V,v=\SI{12}{\volt}] ++(0,2) coordinate (1)
			to[V,v=\SI{6}{\volt}] ++(0,2)
			to[R=\SI{12}{\kilo\ohm},-*] ++(2,0) coordinate (2)
			to[short,-o] ++(1,0) node[right] {A}
...
\draw (0,0) to [V=\SI{10}{\volt}] ++(0,2)
			to [R=\SI{12}{\kilo\ohm}] ++(2,0) coordinate (1)
...
\draw (6.5,0) to[I,l=\SI{0.8}{\milli\ampere}] ++(0,2)
			to [R=\SI{5.6}{\kilo\ohm}] ++(2,0) coordinate (1)
...
\centering
\begin{tikzpicture}[bookcircuit]
\draw (0,0) to[V, v=\SI{12}{\volt},-*]   ++(0,2) coordinate (1) node [left] {}
            to[R, R=\SI{1.2}{\kilo\ohm}, -*] ++(2,0) coordinate (2) node [above] {A}
			to[R, R=\SI{3.9}{\kilo\ohm}, -*] ++(2,0) coordinate (3) node [right] {}
...
\centering
\begin{tikzpicture}[bookcircuit]
\draw (0,0) to[R=\SI{30}{\ohm},-*] ++(0,2) coordinate (1)
            to[V, v<=\SI{10}{\volt},-*] ++(2,0) coordinate (2)
            to[V, v<=\SI{10}{\volt},-*] ++(2,0) coordinate (3) node[right] {A}
...
\draw (0,0) to[V=\SI{12}{\volt}]   ++(0,4) %node (1) {} node [left] {}
            to[short,-*] ++(2,0) node (1) {}
            to[R=\SI{10}{\ohm},-*] ++(0,-2) coordinate (A) node[left] {A}
			to[R=\SI{20}{\ohm},-*] ++(0,-2) coordinate (C)
        (1) to[short] ++(2,0)
            to[R=\SI{40}{\ohm},-*] ++(0,-2) coordinate (B) node[right] {B}
            to[R=\SI{20}{\ohm}] ++(0,-2)
            to[short, -.] (0,0)
        (A) to[R=$R_X$] (B)
...
\draw (0,0) to[V, v=\SI{8}{\volt}]   ++(0,2) %node (1) {} node [left] {}
            to[R=\SI{2}{\ohm},-*] ++(2,0) coordinate (A) node[above] {$U_x$}
			to[R=\SI{4}{\ohm}] ++(2,0)
			to[V, v<=\SI{6}{\volt}]   ++(0,-2) %node (1) {} node [left] {}
            to[short, -.] (0,0)
        (A) to[R=$R_x$] ++(0,-2)
...
\draw (0,0) to[V=$U_1$] ++(0,4)
            to[short] ++(2,0)
            to[R=$R_{in}$, v=$U_{in}$,-*] ++(0,-2) coordinate (1) node[left] {$U_x$}
            to[R=$R_1$,-*] ++(0,-2)
			node[sground] {}
            to[short,-.] ++(-2,0)
            to[open] ++(6.5,4) %node (3) {} node[right] {$U_{2}$}
            to[R=$R_{out}$,] ++(-2,0)
            to[cV, v_<=$aU_{in}$] ++(0,-2) coordinate (2)
			to[short] ++(0,-2) node (2) {}
			to[short] ++(-2.5,0)
		(1) to[short] ++(2.5,0)
			to[R=$R_2$] ++(2,0)
...
\centering
\begin{tikzpicture}[bookcircuit]
\draw (0,0) to[V=\SI{12}{\volt},-*]   ++(0,2) coordinate (1) node [left] {}
            to[R=\SI{1.2}{\kilo\ohm}, -*] ++(2,0) coordinate (2) node [above] {A}
			to[R=\SI{1.5}{\kilo\ohm}, -*] ++(2,0) coordinate (3) node [right] {B}
...
\item
Gegeven is de opamp-schakeling in figuur~\ref{fig:gelopamp1}. De opamp wordt ideaal verondersteld. Bereken de spanningsversterking van $U_{in}$ naar $U_{out}$.
\begin{figure}[!ht]
\centering
\begin{tikzpicture}[bookcircuit]
