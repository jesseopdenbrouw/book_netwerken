...
{\chapnumfont\textcolor{bookcolor}{\thechapter}}
{0ex}
...
\lstset{%
  ...
  numbers=left,
  numberstyle=\tiny\ifusebookasbook\color{gray}\else\color{bookcolor}\fi,
  stepnumber=1,                           
  numbersep=8pt,
  ...
  showtabs=false,
  frame=lines,
  rulecolor=\ifusebookasbook\color{black}\else\color{bookcolor}\fi,
  tabsize=4,
  captionpos=b,
  breaklines=true,
...
\newtcolorbox{infobox}[1][]{title=#1,colback=infoboxbg,colframe=bookcolor,fonttitle=\large\scshape,colbacktitle=infoboxbgtitle,coltitle=black,toptitle=5pt,bottomtitle=5pt,sharp corners,boxrule=2pt,titlerule=0pt,top=7pt,parbox=false}
