...
{\chapnumfont\textcolor{infoboxline}{\thechapter}}
{0ex}
...
\colorlet{listingsbg}{red!50!black}
...
\lstset{%
  ...
  numbers=left,
  numberstyle=\tiny\ifusebookasbook\color{gray}\else\color{infoboxline}\fi,
  stepnumber=1,                           
  numbersep=8pt,
  backgroundcolor=\ifusebookasbook\color{lightgray}\else\color{white}\fi,
  showspaces=false,
  showstringspaces=false,
  showtabs=false,
  frame=lines,
  rulecolor=\ifusebookasbook\color{black}\else\color{infoboxline}\fi,
  tabsize=4,
  captionpos=b,
  breaklines=true,
...
\hypersetup{
	colorlinks=true,
	linkcolor=infoboxline,
	citecolor=infoboxline,
	urlcolor=infoboxline,
    pdftitle={\booktitleI\ \booktitleII, \booksubtitle},
    pdfauthor={\bookauthor},
    %pdfsubject={Beginselen van de digitale techniek},
    pdfsubject={},
...
\newtcolorbox{infobox}[1][]{title=#1,colback=infoboxbg,colframe=infoboxline,fonttitle=\large\scshape,colbacktitle=infoboxbgtitle,coltitle=black,toptitle=5pt,bottomtitle=5pt,sharp corners,boxrule=2pt,titlerule=0pt,top=7pt,parbox=false}
