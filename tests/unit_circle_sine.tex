...
\begin{document}% added - surely necessary! (cfr)
  \centering
  \begin{tikzpicture}[scale=3,cap=round,>=latex,baseline={(0,0)}]
    ...
    \begin{scope}[xshift=20mm]
      ...
      x axis={unit length=5mm, ticks={step=(.5*pi), tick typesetter/.code=\mytypesetter{##1}}},
    ...
    \begin{scope}[on background layer]
      ...
      \foreach \i in {90,120,...,270}
        {
          \draw [densely dashed, opacity=.25, color=blue!50!cyan] (x\i) -- ({x\i} -| o) -- ++(20mm,0) -- ++(pi*\i/360,0) coordinate (xx\i) edge (xx\i |- o);% -- ++(.5*pi,0) coordinate (xxx\i) edge (xxx\i |- o);
