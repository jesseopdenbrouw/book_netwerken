...
We hebben in paragraaf~\ref{sec:belastingskarakteristiek} dat een spanningsbron met serieweerstand
...
Voor de $U_{xa}$ en $I_{xa}$ in netwerk~\ref{fig:gelnetwerkvoorsuperpositiebeginselsplita} kunnen
we opstellen:
%
\begin{equation}
\begin{split}
...
\end{equation}
%
Voor de $U_{xb}$ en $I_{xb}$ in netwerk~\ref{fig:gelnetwerkvoorsuperpositiebeginselsplitb} kunnen
we opstellen:
%
\begin{equation}
\begin{split}
